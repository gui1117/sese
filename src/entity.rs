...
pub fn create_tube(tube: &::tube::Tube, world: &mut ::specs::World) {
    let bodies = match tube.shape {
        ...
        ::tube::Shape::Angle => {
            ...
            let y = (tube.position.rotation * ::na::Point::from_coordinates(::na::Vector3::y())).coords;
            let position = tube.position.append_translation(&::na::Translation::from_vector(-y*0.25));
            ...
            let x = (tube.position.rotation * ::na::Point::from_coordinates(::na::Vector3::x())).coords;
            let position = tube.position.append_translation(&::na::Translation::from_vector(x*0.25));
